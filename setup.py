...
setup(
    ...
    description=' '.join(["ncbi_cds_from_protein is a script and module",
                          "that facilitiates recovery of nucleotide",
                          "sequence, given a set of input protein",
                          "sequences"]),
    license="MIT",
    ...
    scripts=[os.path.join('bin', 'ncbi_cds_from_protein')],
